                            ...
                            <li className="animate-box fadeInUp animated-fast">
                                ...
                                <div className="timeline-panel">
                                    <div className="timeline-heading">
                                        ...
                                        <span className="date">May 8, 2023</span>
                                    </div>
                            ...
                            <li className="timeline-inverted animate-box fadeInUp animated-fast">
                                ...
                                <div className="timeline-panel">
                                    <div className="timeline-heading">
                                        ...
                                        <span className="date"><i className="icon icon-date"></i>May 29, 2023</span>
                                    </div>
                                    <div className="timeline-body">
                                        <p>Came to her home with excitement to meet her again. Our first date.</p>
                                    </div>
                                </div>
                            </li>
                            <li className="animate-box fadeInUp animated-fast">
